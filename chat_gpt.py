    ...
    if otvet.find('прив') > -1:
        ...
        for i in range(3):
            ...
            if num == win_num:
                ...
                print('Неверно')
    elif otvet.find('мага') > -1:
        #придумайте логику для магазина
        pass
    elif otvet.find('филь') > -1:
        #продолжите логику рекомендации фильмов
        genre = input('какой жанр вас интересует?')
        if genre == 'комедия':
            print('Тупой и еще тупее')
    else:
        print('Такой команды я пока низнаю!')

    otvet = input('Что нибудь еще?').lower()

print('Доброго пути господин . . .')
