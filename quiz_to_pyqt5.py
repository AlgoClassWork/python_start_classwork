...
questions = [
    ...
    Question('Государственный язык Бразилии?', 'Португальский', 'Испанский', 'Английский', 'Бразильский'),
    Question('Какой язык самый распространенный в мире?', 'Английский', 'Испанский', 'Китайский', 'Русский'),
    Question('Какой язык самый древний?', 'Санскрит', 'Китайский', 'Арамейский', 'Греческий'),
    Question('Какой язык самый сложный?', 'Китайский', 'Русский', 'Арабский', 'Японский'),
